module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    jsFiles: [
      ...
      'vendor/scripts/before/loader.js'
      ...
      'vendor/scripts/before/the-tramp.js'
  ...
  grunt.registerTask 'b',       ['clean:dist', 'prep', 'concat:devJs', 'copy:dist', 'uglify:dev']
  ...
  #grunt.registerTask 'w',       ['b', 'livereload', 'express:dev', 'watch']
